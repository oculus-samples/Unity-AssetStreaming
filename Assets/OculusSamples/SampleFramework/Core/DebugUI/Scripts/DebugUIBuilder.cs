...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  public void Awake()
  {
    ...
    instance = this;
    // AssetStreaming Sample: use localPosition as reference point
    menuOffset = transform.localPosition; // transform.position; // TODO: this is unpredictable/busted
  ...
  public void Hide()
  {
    // AssetStreaming Sample: don't need to hide if already inactive
