...
// Add namesapce to avoid conflict with Oculus Integration Package implementation.
// there was an ambiguity for the use of this file by TeleportTransitionWarpInspector.cs
namespace Oculus.Samples.Locomotion
{
	/// <summary>
	...
	public class TeleportTransitionWarp : TeleportTransition
	{
		...
		/// </summary>
		[Tooltip("How much time the warp transition takes to complete.")] [Range(0.01f, 1.0f)]
		...
		/// </summary>
		[HideInInspector] public AnimationCurve PositionLerp = AnimationCurve.Linear(0, 0, 1, 1);
